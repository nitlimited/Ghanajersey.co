...
| `REACT_APP_SITE_URL` | Recommended | Canonical frontend site URL used for SEO tags and structured data |
...
For SEO tags and canonical URLs, set:
...
- Dynamic page SEO on the homepage, product listing pages, product detail pages, and blog pages
- Canonical tags, Open Graph tags, Twitter tags, and structured data
- Dynamic `robots.txt` and `sitemap.xml` generated by the backend
- Public blog section at `/blog`
- Admin blog editor at `<admin-portal-path>/blog`
- Blog editor fields for:
  - slug
  - meta title
  - meta description
  - canonical URL
